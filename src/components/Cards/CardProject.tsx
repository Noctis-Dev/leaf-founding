...
function CardProject({ text, title, team, price }: CardProjectProps) {
    return (
        <div>
            <Card className='bg-gray-900 border border-gray-900 rounded-lg shadow dark:bg-gray-900 dark:border-gray-900 lg:py-0 md:py-16'>
