import NewProjectCard from "../NewProjectSection/NewProjectCard";
import { Carousel } from "flowbite-react";
import { useState, useEffect } from "react";

function CarouselCardsThree() {
  ...
  const cards = [<NewProjectCard text={text1} team={team1} title={title1}/>, <NewProjectCard text={text2} team={team2} title={title2}/>, <NewProjectCard text={text3} team={team3} title={title3}/>, <NewProjectCard text={text4} team={team4} title={title4}/>]
  ...
  <section className="bg-gray-800 dark:bg-gray-800">
    <div className="mx-auto max-w-screen-xl items-center px-3 sm:px-5 md:px-4 md:py-16 gap-8 sm:py-16 md:grid md:grid-cols-1 lg:px-12 xl:gap-16">
      <div className="grid-cols-1">
        <h2 className="text-4xl font-extrabold tracking-tight text-green-500 dark:text-green-500 mb-9 text-center ">
        Nuevos proyectos
        </h2>
        <p className="text-gray-400 dark:text-gray-400 md:text-lg text-center">
        Estos son los proyectos creados en as ultimas horas, estos te pueden
        </p>
        <p className="text-gray-400 dark:text-gray-400 md:text-lg text-center">
        llamar tu atencion.
        </p>
      ...
      <div className="py-3 gap-4 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <div className="sm:col-span-1 md:col-span-2 lg:col-span-3 md:h-full min-h-[250px]">
...
export default CarouselCardsThree;